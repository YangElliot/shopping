...
public class RabbitMQConfig {
    ...
    @Bean
    public TopicExchange initRegisterExchange(){
    ...
    @Bean
    public Binding initBindEmail(Queue initEmailQueue, TopicExchange initRegisterExchange){
        return BindingBuilder.bind(initEmailQueue).to(initRegisterExchange).with("user.add");
    }
